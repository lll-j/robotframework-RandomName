...
__last_names = ['赵', '钱', '孙', '李', '周', '吴', '郑', '王', '冯', '陈', '褚', '卫', '蒋', '沈', '韩', '杨', '朱', '秦', '尤', '许',
...
__last_names2 = ["百里", "北堂", "北野", "淳于", "成公", "陈生", "端木", "东方", "东郭", "东野", "东门", "第二", "第五", "大狐", "公孙", "公冶", "公羊",
                 "公良", "公西", "公孟", "高堂", "高阳", "皇甫", "夹谷", "敬花", "梁丘", "令狐", "闾丘", "洛阳", "陵尹", "冷富", "南宫", "南郭", "女娲",
                 "欧阳", "濮阳", "青阳", "漆雕", "亓官", "壤驷", "上官", "少室", "少叔", "司徒", "司马", "司迁", "司空", "司寇", "士孙", "申屠", "澹台",
                 "太史", "太叔", "太公", "闻人", "巫马", "微生", "王孙", "夏侯", "西门", "歆颖", "鲜于", "轩辕", "相里", "乐正", "羊舌", "羊角", "延陵",
                 "诸葛", "颛孙", "仲孙", "仲长", "钟离", "宗政", "主父", "常夏", "陈梁", "陈林", "曹岳", "邓李", "范姜", "郭罗", "高陈", "胡杨", "黄方",
                 "刘付", "刘谭", "陆费", "陆叶", "钱王钱赖", "巫许", "吴刘", "吴沈", "有琴", "张包", "张简", "钟任", "章项", "单于", "叱干", "叱利",
                 "独孤", "赫连", "呼延", "贺兰", "夹谷", "吉胡", "敬花", "慕容", "万俟", "纳兰", "拓跋", "秃发", "完颜", "宇文", "尉迟", "长孙"]

__first_names = ['的', '一', '是', '了', '我', '不', '人', '在', '他', '有', '这', '个', '上', '们', '来', '到', '时', '大', '地', '为',
...
def __last_name2():
    ...
    :return:
    """
    return __get_random_list_value(__last_names2)
...
def __last_name1():
    ...
    :return:
    """
    return __get_random_list_value(__last_names)
...
def __first_name():
    ...
    :return:
    """
    return __get_random_list_value(__first_names)
...
def random_chinese_name():
    ...
    """
    len_name = [2, 3, 4]
    case_number = __get_random_list_value(len_name)
    if case_number == 2:
        name = '{}{}'.format(__last_name1(), __first_name())
    if case_number == 3:
        name = '{}{}{}'.format(__last_name1(), __first_name(), __first_name())
    if case_number == 4:
        name = '{}{}{}'.format(__last_name2(), __first_name(), __first_name())
    return name


def random_chinese_name_length(len_name):
    """生成随机中文名字
...
def __get_random_list_value(list_object):
...
if __name__ == '__main__':
    ...
    for i in range(10):
        name = random_chinese_name_length(4)
        print(name, lazy_pinyin(name), '声调：', pinyin(name, style=Style.TONE3)[0][0][-1],
              pinyin(name, style=Style.TONE3)[1][0][-1], pinyin(name, style=Style.TONE3)[2][0][-1],
              pinyin(name, style=Style.TONE3)[3][0][-1])
